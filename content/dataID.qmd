...
For the first goal, we are exploring trends using 2004-2014 East Coast US detection data (described in Davis et al. 2020, Global Change Biology) and additional NEFSC acoustic data from the East Coast US from 2015 onwards.
